...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// 
        /// It is using recursive and keep tracking dependents
        /// to find if there is CircularException. I carefully 
        /// want to say it is similar concept of finding cycle
        /// in graph.
        /// 
        /// For example, A => {B}. B => {C}, C => {D}
        /// We start with A's dependents which is {B}
        /// visited = {A}
        /// visited not contain n which is 'B'
        /// call Visit method with parameter (A,B, visited, changed)
        /// visited = {A,B}
        /// n = > C
        /// visited not contain "C"
        /// call Visit method with parameter (A,C,visited, changed)
        /// visited = {A,B,C}
        /// n = > A
        /// n(A) equal with start(A) throw new CircularException
        /// 
        /// 
        /// </summary>
