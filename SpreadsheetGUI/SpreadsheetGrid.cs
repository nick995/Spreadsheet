...
public delegate void ModeHandler(SpreadsheetGrid sender);
...
public class SpreadsheetGrid : ScrollView, IDrawable
{
    ...
    //EditBox that is in other grid.
    public Entry Editbox;
    ...
    public Color _backGroundColor = Colors.White;
    public Color _textColor = Colors.Black;
    public Color _fillColor = Colors.White;
    public Color _lineColor = Colors.Black;
    ...
    public SpreadsheetGrid()
    {
        ...
        //graphicsView.EndInteraction += focusEditBox;
        //change color
        //ABC back ground color
    ...
    public void changeColor()
    {
        ...
        this.graphicsView.Background = _backGroundColor;
        //redrawing to change colors.
        Invalidate();
    ...
    public void OnEndInteraction(object sender, TouchEventArgs args)
    {
        ...
        //after this method, EditBox is unfocused.        
    }
